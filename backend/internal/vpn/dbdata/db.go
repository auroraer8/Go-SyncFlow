...
func initDb() {
	...
	// 初始化数据库
	err = xdb.Sync2(&User{}, &Setting{}, &Group{}, &IpMap{}, &AccessAudit{}, &Policy{}, &StatsNetwork{}, &StatsCpu{}, &StatsMem{}, &StatsOnline{}, &UserActLog{}, &AddressGroup{})
	if err != nil {
		base.Fatal(err)
	}
...
func addInitData() error {
	...
	g1 := Group{
		...
		Status:       1,
		Auth:         map[string]interface{}{"type": "syncflow"},
	}
	err = SetGroup(&g1)
	if err != nil {
		return err
