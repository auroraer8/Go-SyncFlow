...
var configs = []config{
	...
	{Typ: cfgStr, Name: "profile_name", Usage: "profile name(用于区分不同服务端的配置)", ValStr: "syncflow-vpn"},
	...
	{Typ: cfgStr, Name: "db_source", Usage: "数据库source", ValStr: "./conf/syncflow-vpn.db"},
	...
	{Typ: cfgStr, Name: "admin_otp", Usage: "管理用户otp,生成命令 ./syncflow-vpn tool -o", ValStr: ""},
